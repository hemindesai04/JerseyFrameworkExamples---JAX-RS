...
public class WebServiceTester {
	...
	//Test: Check if list is not empty
		...
		private void testAddUser(){
			Form form = new Form();
			form.param("id", "4");
			form.param("name", "Evan");
			form.param("profession", "Marketing Manager");
			...
			String result = PASS;
		      if(!RESULT_SUCCESS.equals(callResult))
		         result = FAIL;
		...
		private void testUpdateUser(){
		      Form form = new Form();
		      form.param("id", "1");
		      form.param("name", "Hemin");
		      form.param("profession", "Software Developer");
